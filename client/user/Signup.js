  ...
  const clickSubmit = () => {
    ...
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          <Button color="primary" id="submit-button" variant="contained" onClick={clickSubmit} className={classes.submit}>Submit</Button>
        </CardActions>
      </Card>
      <Dialog open={values.open} disableBackdropClick={true}>
        <DialogTitle id='newAccountTitle'>New Account</DialogTitle>
        <DialogContent>
          <DialogContentText id='newAccountContent'a>
            New account successfully created.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Link to="/signin">
            <Button color="primary" id='sign-in' autoFocus="autoFocus" variant="contained">
              Sign In
            </Button>
          </Link>
        </DialogActions>
